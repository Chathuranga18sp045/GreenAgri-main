...
import { ApiService } from 'src/app/services/api.service';
  ...
  @Component({
    selector: 'app-viewauctionf',
    templateUrl: './viewauctionf.component.html',
    styleUrls: ['./viewauctionf.component.css']
  })
  export class ViewauctionfComponent implements OnInit {
