...
@Component({
  selector: 'app-relieffundtable',
  templateUrl: './relieffundtable.component.html',
  styleUrls: ['./relieffundtable.component.css']
})
export class RelieffundtableComponent implements OnInit {
...
success() {
  ...
  this.router.navigateByUrl('/relief');
}
